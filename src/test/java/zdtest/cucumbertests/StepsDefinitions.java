...
public class StepsDefinitions {
    ...
    public void user_search(String searchingPhrase) {
    ...
    public void top_result_should_contain_the_word(String expectingPhrase) {
        wait.until(ExpectedConditions.urlContains("search?q=" + expectingPhrase));
        ...
        assertTrue(topResultTitle.contains(expectingPhrase));
    }
